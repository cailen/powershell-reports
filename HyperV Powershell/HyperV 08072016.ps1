...
@"
    <div class="container">
        <div class="jumbotron text-center" style="background-color: #00BCD4; color:white; height:300px; padding-top:10px; padding-bottom:10px; margin-bottom:20px;"><h1 class="h1">
