...
<tbody>
    <tr>
        <td style="width:25%;"><button type="button" class="btn btn-$VM_style btn-block disabled">
                    ...
                    <div class="panel-body">
                        <p class="text-center">
                            <div class="btn-group btn-group-justified" role="group">
                                ...
                                <div class="btn-group" role="group">
                                <button type="button" class="btn btn-info disabled">Total vCPUs
                                    <span class="badge">
                                    $(($VMs | Measure-Object ProcessorCount -Sum).Sum)
                                    </span></button>
                                </div>
                                <div class="btn-group" role="group">
                                <button type="button" class="btn btn-primary disabled">Physical CPUs
                                    <span class="badge">
